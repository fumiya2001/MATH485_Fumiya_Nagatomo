...
\newcommand{\blank}{\(\square\)} % ← エラー回避用プレースホルダ
...
I summarized what I did in the file:
\href{https://github.com/fumiya2001/Math485/blob/main/HW01/HMM.ipynb}{\texttt{HMM.ipynb}}
by using a table.
